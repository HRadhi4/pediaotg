...
import { InputWithSignToggle } from "@/components/ui/InputWithSignToggle";
...
const ElectrolytesDialog = ({ open, onOpenChange }) => {
  ...
  const calculateSodium = () => {
    ...
    if (sodiumType === "hyponatremia" && hyponatremiaType === "mild") {
      // Check if fluid deficit should be included
      if (includeFluidDeficit) {
        ...
        // No fluid deficit - only maintenance
        deficit = 0;
      }
    } else {
                      ...
                      {hyponatremiaMethod === "standard" && (
                        <>
                          ...
                          <div className="space-y-2">
                            ...
                            {/* With/Without Deficit Toggle */}
                            <div className="flex gap-2">
                              <button
                                type="button"
                                onClick={() => setIncludeFluidDeficit(true)}
                              ...
                              <button
                                type="button"
                                onClick={() => setIncludeFluidDeficit(false)}
                                className={`flex-1 px-2 py-1.5 text-xs font-medium rounded-md border transition-colors ${
                                  !includeFluidDeficit
                            ...
                            {/* Infant / Child selector - only show if deficit is included */}
                            {includeFluidDeficit && (
                              <>
                                <div className="flex gap-2">
                                  <button
