...
// Ages: <12h, 24h, 36h, 48h, 60h, 72h, 84h, 96-108h, 5days
const THRESHOLDS = {
  // Pre-terms
  "<1kg_<28wk": {
  ...
  "1-1.249kg_28-29wk": {
    ...
    EX: [210, 220, 230, 240, 240, 240, 240, 240, 240]
  },
  "1.25-1.49kg_30-31wk": {
    PT: [80, 110, 140, 160, 170, 170, 170, 170, 170],
    EX: [220, 230, 250, 260, 260, 260, 260, 260, 260]
  },
  "1.5-1.99kg_32-33wk": {
    PT: [80, 120, 150, 180, 190, 200, 200, 200, 200],
    EX: [230, 250, 260, 280, 300, 300, 300, 300, 300]
  },
  "2-2.4kg_34wk": {
    PT: [100, 130, 160, 190, 210, 230, 240, 250, 250],
    EX: [240, 260, 280, 300, 310, 320, 330, 330, 330]
  },
  // Term infants with risk factors (35-37wk + risk)
  "35-37wk_high_risk": {
    PT: [70, 100, 135, 155, 190, 200, 220, 240, 255],
    EX: [200, 220, 255, 270, 290, 310, 310, 330, 330]
  },
  // Term infants medium risk (>=38wk with risk or 35-37wk well)
  "35-37wk_medium_risk": {
    PT: [85, 120, 170, 190, 220, 240, 255, 290, 310],
    EX: [240, 255, 270, 310, 330, 340, 360, 370, 370]
  },
  // Term low risk (>=38wk well)
  ">=38wk_low_risk": {
    PT: [100, 155, 190, 220, 255, 270, 290, 330, 360],
    EX: [270, 290, 330, 360, 370, 390, 410, 430, 430]
  }
};
