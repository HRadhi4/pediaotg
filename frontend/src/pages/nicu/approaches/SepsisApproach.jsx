            ...
            <table className="w-full text-xs border-collapse">
              <thead>
                <tr className="bg-slate-100 dark:bg-slate-700">
                  <th className="text-left py-2 px-2 border border-slate-300 dark:border-slate-600">Type</th>
                  <th className="text-left py-2 px-2 border border-slate-300 dark:border-slate-600">Timing</th>
                  <th className="text-left py-2 px-2 border border-slate-300 dark:border-slate-600">Common Organisms</th>
                  <th className="text-left py-2 px-2 border border-slate-300 dark:border-slate-600">Source</th>
                </tr>
              </thead>
              <tbody className="text-slate-600 dark:text-slate-300">
                <tr>
                  <td className="py-2 px-2 border font-medium text-orange-600 dark:text-orange-400">Early-Onset (EOS)</td>
                  <td className="py-2 px-2 border"><strong>&lt;72 hours</strong></td>
                  <td className="py-2 px-2 border">GBS, E. coli, Listeria</td>
                  <td className="py-2 px-2 border">Vertical (maternal)</td>
                </tr>
                <tr>
                  <td className="py-2 px-2 border font-medium text-purple-600 dark:text-purple-400">Late-Onset (LOS)</td>
                  <td className="py-2 px-2 border"><strong>≥72 hours</strong></td>
                  <td className="py-2 px-2 border">CoNS, S. aureus, GNR, Candida</td>
                  <td className="py-2 px-2 border">Hospital/Community</td>
                </tr>
              </tbody>
            </table>
          </div>
