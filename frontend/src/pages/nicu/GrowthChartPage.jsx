 ...
 * From GitHub repo: https://github.com/HRadhi4/PaedOTG
 */
  ...
  return (
    <div className="space-y-4 p-4" data-testid="growth-chart-page">
      ...
      <Card>
        ...
        <CardContent>
          <div ref={chartRef} className="bg-white dark:bg-gray-900 rounded-lg p-3 overflow-x-auto" style={{ backgroundColor: gender === 'male' ? '#e6f3ff' : '#fff0f5', minHeight: '350px' }}>
                ...
                <div key={entry.id} className="p-3 rounded-xl bg-gray-50 dark:bg-gray-800/50 space-y-2">
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex gap-2 items-center">
                      <span className="font-medium text-teal-500">{entry.date}</span>
