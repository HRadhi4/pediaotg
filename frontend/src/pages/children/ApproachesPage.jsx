...
const ApproachesPage = ({ onBack }) => {
  ...
  const approachTabs = [
    ...
    { id: "iem", label: "IEM Emergencies", keywords: ["iem", "inborn error", "metabolism", "propionic", "methylmalonic", "mma", "msud", "maple syrup", "vlcad", "cpt", "gsd", "glycogen", "urea cycle", "hyperammonemia", "ammonia", "carnitine", "organic acidemia"] },
  ...
  return (
    <div className="space-y-4 pt-4 pb-4">
      ...
      >
        ...
        {activeTab === "metabolic" && <MetabolicEmergencyApproach {...commonProps} />}
        </div>
      </div>
